...
public class RuleParser<INPUT_DATA, OUTPUT_RESULT> {
    ...
    public boolean parseCondition(String expression, INPUT_DATA inputData) {
        ...
        log.info(" resolvedDslExpression===="+resolvedDslExpression);
        Object match = mvelParser.parseMvelExpression(resolvedDslExpression, input);
        log.info(" The match in RuleParser===="+match);
