...
import ng.com.justjava.parser.RuleParser;
...
public abstract class InferenceEngine<INPUT_DATA, OUTPUT_RESULT> {
     ...
     * @return
     */
    protected OUTPUT_RESULT executeRule(ng.com.justjava.domain.Rule rule, INPUT_DATA inputData){
    ...
    protected abstract ng.com.justjava.domain.RuleNamespace getRuleNamespace();
}